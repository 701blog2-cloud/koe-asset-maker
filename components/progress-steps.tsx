...
import { Loader2, Check, Mic, FileText } from "lucide-react";
...
const steps = [
  { key: "extracting" as const, label: "音声を取得中...", icon: Mic },
  { key: "transcribing" as const, label: "文字起こし中...", icon: FileText },
];
          ...
          return (
            ...
            >
              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                isActive ? "bg-primary/20" : isDone ? "bg-green-100" : "bg-muted"
              }`}>
                {isActive ? (
              ...
              <span className={`text-sm font-medium ${
                ...
                {isDone ? s.label.replace("...", " 完了!") : s.label}
              </span>
            </div>
          );
        })}
